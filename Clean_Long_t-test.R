...
# Perform KEGG, Reactome, and GO enrichment analyses
...
# ---- 9. Visualize Enrichment Results ----
...
enrichment_results <- list(
  ...
  "KEGG_Post_vs_Pre_MA"   = kegg_Post_vs_Pre_MA,
  "Reactome_Pre_vs_Young" = reactome_Pre_vs_Young,
  "Reactome_Post_vs_Pre_MA" = reactome_Post_vs_Pre_MA,
  "GO_Pre_vs_Young"       = go_Pre_vs_Young,
  "GO_Post_vs_Pre_MA"     = go_Post_vs_Pre_MA
)

saveRDS(enrichment_results, "Enrichment_Results.rds")


# ---- 11. Facetted “Zoom‑In” Pathway Plots (p ≤ 0.10 only) ----

# Define pathway targets
kegg_targets <- c(
...
# ---- 12. Individual Pathway Radar and Bar Plots with Expanded Categories ----
